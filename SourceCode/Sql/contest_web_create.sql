...
CREATE TABLE `contests` (
	...
	`status_text` VARCHAR(255) DEFAULT(NULL) COMMENT '比赛审核说明',
...
VALUES
	...
	( DEFAULT, '张瓜皮皮', TRUE, '1999-11-20', '西南财经大学', '天门', '13886961359', '13886961359@qq.com', '3', '6437f31087031f66182bb91db6b66580' ),
	( DEFAULT, '小江云子', FALSE, '1999-07-29', '西安交通大学', '黄石', '18453887612', '18453887612@qq.com', '3', '90de7daf04c2bbcffa9638257f3344ea' ),
	( DEFAULT, '德隆东墙', TRUE, '2000-04-05', '武汉设计工程学院', '湖北省武汉市江夏区藏龙岛经济开发区杨桥湖大道一号（武汉设计工程学院）', '13866039800', '13866039800@qq.com', '4', '561b74711257f80bd074356ffca50439' ),
	( DEFAULT, '五号六号', FALSE, '1999-12-12', '中国人民公安大学', '吉林', '13027048577', '13027048577@qq.com', '4', '6c7860b8a17546f8fbfc9611c67f8f1e' ),
	( DEFAULT, '舒服阿寿', TRUE, '2000-12-24', '武汉首义学院', '南宁', '17247196444', '17247196444@qq.com', '4', 'e5ca7cb2e466d6a3f4cf7d32a620664a' ),
	( DEFAULT, '赵同学', FALSE, '1998-05-10', '武汉科技大学', '鄂州', '13704131948', '13704131948@qq.com', '2', '42304b9b0487a31df42097d135c73f9e' ),
	( DEFAULT, '钱同学', TRUE, '2002-01-16', '华中科技大学', '仙桃', '13742968739', '13742968739@qq.com', '2', '17e42ba1f1cc5224098ba65dcdf11fe6' ),
	( DEFAULT, '孙同学', FALSE, '2002-12-30', '电子科技大学', '成都', '15319493760', '15319493760@qq.com', '2', '93c9b76e1778ee063e54cb9331f95e36' ),
	( DEFAULT, '李同学', TRUE, '2001-10-10', '北京大学', '青海', '18282876997', '18282876997@qq.com', '2', '7334261ed30a7b203cb7ee42f589e378' ),
	( DEFAULT, '周同学', TRUE, '2000-02-15', '武汉城市学院', '辽阳', '14984342228', '14984342228@qq.com', '2', '3c64f0ce9febe9d87c5c8572da1d6852' ),
	( DEFAULT, '吴同学', TRUE, '1998-10-08', '华中师范大学', '西安', '14912959902', '14912959902@qq.com', '2', 'c22e024d74590c6e965c45fd4d88e34a' ),
	( DEFAULT, '郑同学', FALSE, '2002-04-16', '复旦大学', '南通', '15089652824', '15089652824@qq.com', '2', 'ab4dcba6bc27ef6db973f68fdb29dceb' ),
	( DEFAULT, '王同学', FALSE, '2003-09-09', '哈尔滨工业大学', '惠州', '15939648850', '15939648850@qq.com', '2', '551447feaf16ab17436f5d5a89a7bf10' );
-- 比赛表:  `contests` 插入数据
...
INSERT INTO `scores`
VALUES
	( DEFAULT, '1', '7', '1', '3', '优秀', '85' ),
	( DEFAULT, '1', '8', '1', '2', '出彩', '91' ),
	( DEFAULT, '1', '9', '1', '3', '良好', '70' ),
	( DEFAULT, '1', '10', '1', '2', '优秀', '84' ),
	( DEFAULT, '1', '11', '1', '3', '不行', '53' ),
	( DEFAULT, '1', '12', '1', '2', '太差', '71' ),
	( DEFAULT, '1', '13', '1', '2', '优秀', '100' ),
	( DEFAULT, '1', '14', '1', '2', '优秀', '98' ),
	( DEFAULT, '2', '7', '1', '5', '没有评语', '48' ),
	( DEFAULT, '2', '8', '1', '6', '评价1', '16' ),
	( DEFAULT, '2', '9', '1', '4', '我得龙东墙觉得不错', '80' ),
	( DEFAULT, '2', '12', '1', '5', '该作品有待改进', '71' ),
	( DEFAULT, '2', '14', '1', '6', '我觉得冠军非你莫属', '98' ),
	( DEFAULT, '3', '9', '1', '4', '评价1', '52' ),
	( DEFAULT, '3', '12', '1', '5', '评价2', '78' ),
	( DEFAULT, '3', '14', '1', '6', '评价3', '89' ),
	( DEFAULT, '4', '7', '0', NULL, NULL, NULL ),
	( DEFAULT, '4', '8', '0', NULL, NULL, NULL ),
	( DEFAULT, '4', '10', '0', NULL, NULL, NULL ),
	( DEFAULT, '4', '13', '0', NULL, NULL, NULL ),
	( DEFAULT, '5', '7', '1', '4', '我得龙东墙觉得不错', '80' ),
	( DEFAULT, '5', '8', '0', NULL, NULL, NULL ),
	( DEFAULT, '5', '9', '1', '4', '我得龙东墙觉得不错', '80' ),
	( DEFAULT, '5', '10', '0', NULL, NULL, NULL ),
	( DEFAULT, '5', '11', '0', NULL, NULL, NULL ),
	( DEFAULT, '6', '7', '0', NULL, NULL, NULL ),
	( DEFAULT, '6', '8', '0', NULL, NULL, NULL ),
	( DEFAULT, '6', '9', '0', NULL, NULL, NULL ),
	( DEFAULT, '6', '10', '0', NULL, NULL, NULL ),
	( DEFAULT, '6', '11', '0', NULL, NULL, NULL ),
	( DEFAULT, '6', '12', '0', NULL, NULL, NULL ),
	( DEFAULT, '6', '13', '0', NULL, NULL, NULL ),
	( DEFAULT, '6', '14', '0', NULL, NULL, NULL );