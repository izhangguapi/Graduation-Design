...
Page({
  ...
  btns:function (event){
    ...
    console.log(aid)
    // console.log(aname)
  var ul= "http://192.168.43.187:8080/link/sign?aid=" + aid + "&uid=" + that.data.userInfo.data.id;
  console.log(ul)
    wx.request({
      url: ul,
      data:{
  ...
  onLoad: function () {
    ...
    var ul = "http://192.168.43.187:8080/activities/unjoin/" + that.data.userInfo.data.id;
    console.log(ul)
    wx.request({
      url: ul,
      data:{
